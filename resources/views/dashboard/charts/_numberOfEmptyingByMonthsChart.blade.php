@include('layouts.dashboard.chart-card',[
    'card_title' => "Number of Emptying Requests by Low Income and other communities",
...
document.getElementById('exportnumberOfEmptyingbyMonthsChart').addEventListener("click", downloadIMG);
  ...
  function downloadIMG() {
    ...
    a.download = 'Number of Emptying Requests by Low Income Communities, other communities.png';
