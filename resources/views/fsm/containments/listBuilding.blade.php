...
<div class="row">
    ...
    <div class="card">
        <div class="card-header">
          <a href="{{ action('Fsm\ContainmentController@index') }}" class="btn btn-info">Back to the Containment List</a>
          @can('View Map')
          <!-- <a href="{{ action('MapsController@index', ['layer' => 'jhe_containment', 'field' => 'containcd', 'val' => $containment->containcd, 'action' => 'containment-buildings']) }}" class="btn btn-info">View in Map</a> -->
          @endcan
        </div><!-- /.card-header -->
        <div class="card-body">
