...
Developed By: Innovative Solution Pvt. Ltd. (ISPL)  (© ISPL, 2022) --><!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse layout-fixed">
    ...
    <!-- REQUIRED JS SCRIPTS -->
    <script async defer src="http://maps.google.com/maps/api/js?key=AIzaSyDmVQe2fGH3kdKwNoP2mZJzoza2_J7WzKI&v=3&callback=initMap"></script>
