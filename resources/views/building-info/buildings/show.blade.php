    ...
    <div class="card card-info">
        ...
        <div class="card-body">
            ...
            <div class="form-group row" id="building_associated">
                {!! Form::label('is_main_building', 'Is Main Building', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row" id="building_associated">
                {!! Form::label('building_associated_to', 'Main Building Number', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                {!! Form::label('ward', 'Ward No', ['class' => 'col-sm-2 control-label ']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                {!! Form::label('road_code', 'Rode Code', ['class' => 'col-sm-2 control-label control-label ']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                {!! Form::label('house_number', 'House Address', ['class' => 'col-sm-2 control-label control-label ']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row" id="construction-year">
                {!! Form::label('construction_year', 'Building Construction Year', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                {!! Form::label('floor_count', 'Total No. of Floors', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                {!! Form::label('use_category_id', 'Use Categories of Buildings', ['class' => 'col-sm-2 control-label ']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                {!! Form::label('is_lic', 'Is LIH', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    {!! Form::text('lic_status', !empty($building->Lic->community_name) ? 'Yes' : null, [
                        'class' => 'form-control col-sm-10 font-weight-bold',
                        'readonly' => 'readonly',
                    ]) !!}
                </div>
            ...
            <div class="form-group row">
                {!! Form::label('watersupply_pipe_code', 'Water Supply Pipeline Code', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row" id="well-presence">
                {!! Form::label('well_presence_status', 'Well Presence', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row" id="distance-from-well">
                {!! Form::label('distance_from_well', 'Distance of Containment from Well (m)', [
                    'class' => 'col-sm-2 control-label',
                ]) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                {!! Form::label('toilet_count', 'Toilet Count', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                {!! Form::label('no_hh_shared_toilet', 'Households with Shared Toilet', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-3">
                    {!! Form::text('no_hh_shared_toilet', $building->no_hh_shared_toilet, [
                        'class' => 'form-control col-sm-10 font-weight-bold',
                        'readonly' => 'readonly',
                    ]) !!}
                </div>
            ...
            <div class="form-group row">
                {!! Form::label('population_shared_toilet', 'Population that uses Shared Toilet', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-3">
                    {!! Form::text('population_shared_toilet', $building->population_shared_toilet, [
                        'class' => 'form-control col-sm-10 font-weight-bold',
                        'readonly' => 'readonly',
                    ]) !!}
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    {!! Form::label('build_contain', 'BIN of Pre-Connected Building', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-3">
                        {!! Form::text('build_contain', $building->build_contain, [
                            'class' => 'form-control col-sm-10 font-weight-bold',
                            'readonly' => 'readonly',
                        ]) !!}
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        {!! Form::text('desludging_vehicle_accessible', $building->desludging_vehicle_accessible == 1 ? 'Yes' : ($building->desludging_vehicle_accessible == 0 ? 'No' : null), [
                            'class' => 'form-control col-sm-10 font-weight-bold',
                            'readonly' => 'readonly',
                        ]) !!}
                    </div>
