    ...
    <div class="sus sus1">
        ...
        <div class="chart" id="ss1Contain">
            <figure class="chart__figure">
                <canvas class="chart__canvas" id="ss1Canva" width="160" height="140" aria-label="Example doughnut chart showing data as a percentage" role="img"></canvas>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                createDoughnutChart({{ html_entity_decode($ss1[0]->data_value) }}, '#E49B0F', 'ss1Canva', 'ss1Contain');
            });
        </script>
    </div>
