                                ...
                                <div class="accordion-body">
                                    <form class="form-horizontal" id="filter-form">
                                        <div class="form-group row">
                                            ...
                                            <label for="project_name" class="col-md-2 col-form-label ">City Water Supply</label>
                                            <div class="col-md-2">
                                                <input type="text" class="form-control" id="project_name" placeholder="City Water Supply" />
                                            </div>
...
$(function() {
  var dataTable = $('#data-table').DataTable({
    ...
    $("#export-kml").on("click", function(e) {
        ...
        window.location.href = "{{ Config::get("constants.GEOSERVER_URL") }}wfs?service=WFS&version=1.0.0&request=GetFeature&authkey={{ Config::get("constants.AUTH_KEY") }}&typeName={{ Config::get("constants.GEOSERVER_WORKSPACE") }}:watersupply_network_layer+&CQL_FILTER=" + cql_param +
            " &outputFormat=KML";
    });
