...
-   Opens the generated link in a new browser window, triggering the download of the exported file (shapefile or KML).
...
The points mentioned below for displaying map adheres to the comment in the code. Here, GEOSERVER_WORKSPACE, GEOSERVER_URL, and AUTH_KEYare further elaborated in the .env file, as described in Section **Error! Reference source not found.**.
...
extent: ol.proj.transformExtent([85.3336173378804403, 27.5927394795208549, 85.4356944303740136, 27.6717448112185735], 'EPSG:4326', 'EPSG:3857')
...
[base_url+//wms?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image%2Fpng&TRANSPARENT=true&LAYERS=imis_base%3Abuildings_layer&TILED=true&STYLES=imis_base%3Abuildings_layer_none&CRS=EPSG%3A3857&FORMAT_OPTIONS=dpi%3A135&WIDTH=1632&HEIGHT=1141&BBOX=9503530.979402674%2C3203059.532398772%2C9503855.836772887%2C3203286.653881255](http://202.52.0.116:8080/geoserver/imis_base/wms?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image%2Fpng&TRANSPARENT=true&LAYERS=imis_base%3Abuildings_layer&TILED=true&STYLES=imis_base%3Abuildings_layer_none&CRS=EPSG%3A3857&FORMAT_OPTIONS=dpi%3A135&WIDTH=1632&HEIGHT=1141&BBOX=9503530.979402674%2C3203059.532398772%2C9503855.836772887%2C3203286.653881255)

GetLegendGraphic example request

[base_url+//wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&BBOX=84.883118,27.149589,85.896606,28.071980&LAYER=imis_base:buildings_layer&LEGEND_OPTIONS=countMatched:TRUE;fontName:Lucida%20Bright;fontAntiAliasing:true;&STYLE=imis_base:buildings_layer_none](http://202.52.0.116:8080/geoserver/imis_base/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&BBOX=84.883118,27.149589,85.896606,28.071980&LAYER=imis_base:buildings_layer&LEGEND_OPTIONS=countMatched:TRUE;fontName:Lucida%20Bright;fontAntiAliasing:true;&STYLE=imis_base:buildings_layer_none)
...
-   It assigns an icon to the feature based on the status of some properties like "sludge_collection_status", "feedback_status", "emptying_status", "assessment_status".
...
| **Source**      | app\\Http\\Controllers\\ MapsService.php                                                                                                                                                                                                                                                                                                                                        |
| **Remarks**     | Use a ufunction to get building data as fnc_getBufferPolygonBuildings( ST_GeomFromText(" . "'" . "\$bufferPolygonGeom" . "'" . ",4326), \$bufferDistancePolygon) further explained in Section **Error! Reference source not found.** popUpContentHtml(\$buildingResults): Generates HTML content for displaying based on summary data of building information in a table format |
...
| **Source**      | app\\Http\\Controllers\\ MapsService.php                                                                                                                                                                                                                                                   |
| **Remarks**     | use a function to get point buffer buildings “fnc_getPointBufferBuildings” which is mentioned in Section **Error! Reference source not found.** popUpContentHtml(\$buildingResults): Generates HTML content for displaying based on summary data of building information in a table format |
...
| **Source**      | app\\Http\\Controllers\\ MapsService.php                                                                                                                                                                                                                                                                                                                        |
| **Remarks**     | Use a ufunction to get building data as fnc_getBufferPolygonBuildings ( ST_GeomFromText(" . "'" . "\$remainingPolygonGeom" . "'" . ",4326), 0) further explained in Section **Error! Reference source not found.** popUpContentHtml(\$buildingResults) : Generates HTML content for displaying based on summary data of building information in a table format  |
