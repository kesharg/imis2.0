...
Route::group([
    ...
    */
    ...
    | Assessment Routes---------------------------------------------------
    |
    | /applications : Get list of applications for assessment
    | /save-assessment : Save the assessment data
    |
    */
    Route::group(['name' => 'assessment'],function (){
        Route::get('/applications',[AssessmentController::class,'getApplications']);
        Route::get('/save-assessment',[AssessmentController::class,'save']);
    });
    ...
    | /vacutug-types : Get list of vacutug types
