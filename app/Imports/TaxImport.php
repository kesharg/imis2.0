...
class TaxImport implements ToModel, WithHeadingRow, WithChunkReading,WithValidation, SkipsOnError, WithColumnFormatting, WithMapping, WithBatchInserts, SkipsOnFailure, ShouldQueue 
{
    use Importable;
