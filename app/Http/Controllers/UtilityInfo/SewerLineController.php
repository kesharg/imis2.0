...
class SewerLineController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if ($sewerLine) {
            ...
            return view('utility-info/sewer-lines.show', compact('page_title', 'sewerLine'));
        } else {
            abort(404);
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($sewerLine) {
            ...
            // Format the length attribute to display only two decimal places
            $sewerLine->length = number_format($sewerLine->length, 2);
            $treatdrp = TreatmentPlant::pluck('name','id');
    ...
    public function update(SewerLineRequest $request, $id)
    {
        ...
        if ($sewerLine) {
            ...
            return redirect('utilityinfo/sewerlines')->with('success','Sewer Line updated successfully');
        } else {
