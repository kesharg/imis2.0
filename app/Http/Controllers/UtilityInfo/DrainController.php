...
class DrainController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if ($drain) {
            ...
            return view('utility-info/drains.show', compact('page_title', 'drain'));
        } else {
            abort(404);
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($drain) {
            ...
            $treatmentPlants = TreatmentPlant::pluck('name','id')->unique();
    ...
    public function update(DrainRequest $request, $id)
    {
        ...
        if ($drain) {
            ...
            return redirect('utilityinfo/drains')->with('success','Drain updated successfully');
        } else {
