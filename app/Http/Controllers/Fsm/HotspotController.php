...
use App\Http\Requests\Fsm\HotspotRequest;
use App\Services\Fsm\HotspotServiceClass;
...
class HotspotController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('fsm.hotspots.index', compact('page_title','wards','enumValues','hotspotLocation'));
    }
    ...
    public function create()
    {
        ...
        $enumValues = HotspotDisease::toEnumArray();
        return view('fsm.hotspots.create', compact('page_title','wards', 'maxDate', 'minDate','diesase', 'enumValues'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($Hotspots) {
            ...
            return view('fsm.hotspots.edit', compact('page_title', 'wards', 'Hotspots', 'geom', 'lat', 'long','diesase', 'enumValues'));
        } else {
            abort(404);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if ($Hotspots) {
                $Hotspots->delete();
                return redirect('fsm/hotspots')->with('success','Waterborne Hotspot deleted successfully');
        } else {
            return redirect('fsm/hotspots')->with('error','Failed to delete Hotspot Identification');
        }
    }
    /**
    ...
    */
    public function history($id)
    {
        ...
        if ($Hotspots) {
            ...
            return view('fsm.hotspots.history', compact('page_title', 'Hotspots'));
        } else {
            abort(404);
        }
    }
