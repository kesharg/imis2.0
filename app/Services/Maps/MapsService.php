...
class MapsService {
   ...
   /**
    ...
    public function mapsIndex() 
    {
        ...
        $taxZones = TaxZone::orderBy('id', 'asc')->pluck('id', 'id')->all();
        ...
        return view('maps.index', compact('page_title', 'wards', 'taxZones', 'dueYears', 'maxDate',
    ...
    public function getApplicationContainments()
    {
        ...
        $query = "SELECT s.company_name, a.id AS application_id,a.house_number,a.application_date, a.assessment_status, a.emptying_status, a.feedback_status, a.sludge_collection_status, c.id AS containment_id, ST_X(c.geom) AS long, ST_Y(c.geom) AS lat"
            . " FROM fsm.applications a"
            . " LEFT JOIN building_info.buildings b"
            . " ON a.house_number = b.bin"
    ...
    public function getApplicationContainmentsYearMonth($year, $month)
    {
        ...
        $query = "SELECT a.id AS application_id,a.house_number, s.company_name, a.assessment_status, a.emptying_status, a.feedback_status, a.sludge_collection_status, c.id AS containment_id, ST_X(c.geom) AS long, ST_Y(c.geom) AS lat"
            . " FROM fsm.applications a"
            . " LEFT JOIN building_info.buildings b"
            . " ON a.house_number = b.bin"
            . " LEFT JOIN building_info.build_contains bc"
    ...
    public function getApplicationNotTPOnDate($start_date)
    {
        ...
        $query = "SELECT a.id AS application_id,a.application_date,a.house_number,e.emptied_date,s.id,s.company_name, a.assessment_status, a.emptying_status, a.feedback_status, c.id AS containment_id, ST_X(c.geom) AS long, ST_Y(c.geom) AS lat"
            . " FROM fsm.applications a"
            . " LEFT JOIN building_info.bin b"
            . " ON a.house_number = b.bin"
            . " LEFT JOIN building_info.build_contains bc"
            . " ON bc.bin = b.bin"
            . " LEFT JOIN fsm.containments c"
    ...
    public function getApplicationNotTP()
    {
        ...
        if (Auth::user()->hasRole('Service Provider - Admin') || Auth::user()->hasRole('Service Provider - Help Desk') ) {
         ...
         // Construct the SQL query to retrieve application data along with related information:
        $query = "SELECT a.id AS application_id,a.house_number,a.application_date,s.id,s.company_name,e.emptied_date, c.id AS containment_id, ST_X(c.geom) AS long, ST_Y(c.geom) AS lat"
            . " FROM fsm.applications a"
            . " LEFT JOIN building_info.buildings b"
            . " ON a.house_number = b.bin"
            . " LEFT JOIN building_info.build_contains bc"
    ...
    public function getApplicationNotTPContainmentsYearMonth($year, $month)
    {
        ...
        if ($month) {
         ...
         // Construct the SQL query to retrieve application data along with related information:
        $query = "SELECT a.id AS application_id,a.house_number,a.application_date,e.emptied_date,s.id,s.company_name, a.assessment_status, a.emptying_status, a.feedback_status, c.id AS containment_id, ST_X(c.geom) AS long, ST_Y(c.geom) AS lat"
            . " FROM fsm.applications a"
            . " LEFT JOIN building_info.buildings b"
            . " ON a.house_number = b.bin"
            . " LEFT JOIN building_info.build_contains bc"
    ...
    public function getFeedbacksCount($geom, $whereUser)
    {
        ...
        $query = "SELECT COUNT(c.id) AS total_count"
    ...
    public function getProposedEmptyingContainmentsInfo($start_date, $end_date)
    {
        ...
        $query = "SELECT c.id, ST_X(c.geom) AS long, ST_Y(c.geom) AS lat"
            ...
            . " ON a1.house_number = b.house_number"
