    ...
    public function getAllData($data)
    {
        ...
        return Datatables::of($sewercollectionData)
            ...
            ->addColumn('action', function ($model) {
                ...
                $content .= '<a title="Map" data-toggle="modal" data-target="#exampleModal" class="btn btn-info btn-sm mb-1 mr-1" data-id="'.$model->bin.'" data-sewer-code="'.$model->sewer_code.'"><i class="fas fa-eye"></i></a> ';
                }
