...
class WaterSupplyFunctionBuild extends Command
{
     ...
     * @var string
     */
    protected $description = 'Creates Functions to create table and update building owner when new watersupply data is imported';
    ...
    public function handle()
    {
         ...
         DB::unprepared(Config::get('watersupply-info.fnc_insrtupd_taxbuildowner'));
         DB::unprepared(Config::get('watersupply-info.fnc_create_wardproportion'));
         DB::unprepared(Config::get('watersupply-info.fnc_create_gridproportion'));
