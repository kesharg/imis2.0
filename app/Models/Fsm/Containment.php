...
class Containment extends Model
{
    ...
    {
        return $this->belongsToMany('App\Models\BuildingInfo\Building', 'building_info.build_contains', 'containment_id', 'bin','id')->whereNull('build_contains.deleted_at')->withPivot(['bin', 'containment_id', 'main_building']);
    }
